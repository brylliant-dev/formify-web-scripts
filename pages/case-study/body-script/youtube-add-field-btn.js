    ...
    addFieldButton.addEventListener('click', function () {
        ...
        if (currentFieldsCount < maxFields) {
            ...
            if (templateField) {
                ...
                // Update the first input field's ID and related attributes
                ...
                // Update the second input field's ID and related attributes
                const thumbnailField = newFieldWrapper.querySelector('input.youtube-humbnail');
                if (thumbnailField) {
                    const newId = `thumbnail-${fieldCounter}`;
                    thumbnailField.id = newId;
                    thumbnailField.name = `Youtube-Thumbnail-${fieldCounter}`;
                    thumbnailField.setAttribute('data-name', `Youtube Thumbnail ${fieldCounter}`);
                    thumbnailField.value = ''; // Clear any pre-filled value
                }
